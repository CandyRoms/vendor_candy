...
PRODUCT_COPY_FILES += \
    ...
    vendor/candy/prebuilt/common/etc/sysconfig/lawnchair-hiddenapi-package-whitelist.xml:$(TARGET_COPY_OUT_SYSTEM)etc/sysconfig/lawnchair-hiddenapi-package-whitelist.xml
