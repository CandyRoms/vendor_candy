...
# Layers Backup
PRODUCT_COPY_FILES += \
    vendor/candy/prebuilt/common/addon.d/71-layers.sh:system/addon.d/71-layers.sh
...
PRODUCT_VERSION_MINOR = 3.0.L
PRODUCT_VERSION_MAINTENANCE = 3.0.L
...
# Set all versions
CANDY_VERSION := CandySiX-$(PRODUCT_VERSION_MAINTENANCE)-$(CANDY_BUILDTYPE)$(CANDY_POSTFIX)
CANDY_MOD_VERSION := CandySiX-$(CANDY_BUILD)-$(PRODUCT_VERSION_MAINTENANCE)-$(CANDY_BUILDTYPE)$(CANDY_POSTFIX)
