...
if __name__ == '__main__':
    ...
    default_gerrit = 'https://gerrit.candyroms.org'
    ...
    for item in mergables:
        ...
        if args.gerrit == default_gerrit:
            ...
            if args.pull:
                cmd = ['git pull --no-edit candy', item['fetch'][method]['ref']]
            else:
        ...
        if args.gerrit != default_gerrit or os.stat(FETCH_HEAD).st_size == 0:
            # If not using the default gerrit or candy failed, fetch from gerrit.
            if args.verbose:
                if args.gerrit == default_gerrit:
